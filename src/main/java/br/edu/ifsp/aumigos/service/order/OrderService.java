...
public class OrderService {
    ...
    public void processOrderItems(Map<Integer, Integer> products, Integer clientId, Integer paymentMethodId, Address address) {
        ...
        for (Map.Entry<Integer, Integer> entry : products.entrySet()) {
            ...
            if (!productService.isProductInStock(product.getId(), quantity)) throw new RuntimeException("O produto " + product.getName() + " está fora de estoque ou não tem quantidade suficiente.");
